...
final hepa = AntigenSupportingData.fromJson({
  ...
  "series": [
    ...
    },
    {
      ...
      "indication": [
        {
          "observationCode": {"text": "Travelling Internationally"},
          "description":
    ...
    },
    {
      ...
      "indication": [
        {
          "observationCode": {"text": "Patient seeks protection"},
        ...
        {
          "observationCode": {"text": "Men who have sex with men"},
          "description": "Administer to men who have sex with men.",
          "beginAge": "19 years"
        },
        {
          "observationCode": {"text": "Illicit drug use"},
        ...
        },
        {
          ...
          "beginAge": "19 years",
          "guidance":
              "close personal contact includes but is not limited to household contact, caretaker, or regular babysitter. The first dose of the HepA vaccine seriesshould be administered as soon as adoption is planned, ideally 2 or more weeks before the arrival of the adoptee"
        },
        {
          "observationCode": {"text": "Occupational exposure for Hepatitis A"},
          "description":
        ...
        {
          "observationCode": {"text": "Patient seeks Hepatitis A  protection"},
          "description":
