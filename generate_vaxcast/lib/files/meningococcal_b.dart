...
final meningococcalB = AntigenSupportingData.fromJson({
  ...
  "series": [
      ...
      "indication": [
        {
          ...
          "endAge": "24 years",
          "guidance":
              "A MenB vaccine series may be administered to adolescents and young adults to provide short-term protection against most strains of serogroup B meningococcal disease. The preferred age for MenB vaccination is 16-18 years (recommendation Category B)."
        },
        {
          "observationCode": {
    ...
    },
    {
      ...
      "indication": [
        {
          "observationCode": {"text": "Undergoing elective splenectomy"},
          "description":
