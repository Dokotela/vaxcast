  ...
  "observations": {
    "observation": [
      ...
      },
      {
        ...
        "clarifyingText":
            "e.g., household or regular babysittingApplies when adoptee is from a country with high or intermediate endemicity"
      },
      {
        "observationCode": "045",
        "observationTitle":
      ...
      },
      {
        ...
        "contraindicationText":
            "Do not vaccinate if the patient has progressive neurologic disorder until a treatment regimen has beenestablished and the condition has stabilized.",
        "clarifyingText":
            "Includes infantile spasms, uncontrolled epilepsy, or progressive encephalopathy for the administration of any pertussis-containingvaccine",
        "codedValues": {
          "codedValue": [
            {
              "code": "84757009",
      ...
      },
      {
        ...
        "contraindicationText":
            "Do not vaccinate if the patient has chronic renal disease.",
        "codedValues": {
          "codedValue": [
            {
              "code": "709044004",
      ...
      },
      {
        ...
        "clarifyingText":
            "Having damaged or scarred lung tissue such as interstitial lung disesase",
        "codedValues": {
          "codedValue": [
            {
              "code": "233703007",
