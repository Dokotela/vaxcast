  ...
  for (var forecast in groupForecast) {
    ...
    immunizationRecommendation.recommendation.add(
      ImmunizationRecommendationRecommendation(
        ...
        vaccineCode: forecast.groupRecVaccines.keys.isEmpty
            ? null
            : [
                CodeableConcept(
        ...
        series: stringFromVaccineGroupName[forecast.vaccineGroupName],
      ),
    );
  }
    ...
    ParametersParameter(
      ...
      resource: ImmunizationEvaluation(
        ...
        doseNumberPositiveInt: dose.evaluation.value1 == EvalStatus.valid
            ? PositiveInt(dose.target.value1 + 1)
            : null,
...
List<Coding> listCvx(GroupForecast groupForecast, String id) {
  ...
  var vaccineList = groupForecast.groupRecVaccines.keys.toList();
