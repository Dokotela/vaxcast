...
class VaxPatientDstu2 extends VaxPatient {
  VaxPatientDstu2({
    dstu2.Patient patient,
    List<dstu2.Immunization> immunizations,
    List<dstu2.Condition> conditions,
    List<dstu2.AllergyIntolerance> allergyIntolerance,
  ...
  Dose getNewDose(dstu2.Immunization vax) => Dose(
  ...
  List<String> getConditions(List<dstu2.Condition> conditions) {
