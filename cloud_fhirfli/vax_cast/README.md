...
The last argument is because mine kept timing out when building
```
gcloud builds submit --tag gcr.io/PROJECT-ID/nameOfProject --timeout=1200s
```
Again, you don't have to select a managed platform, it should give you the option for you to choose
```
gcloud run deploy --image gcr.io/PROJECT-ID/nameOfProject --platform managed
```
