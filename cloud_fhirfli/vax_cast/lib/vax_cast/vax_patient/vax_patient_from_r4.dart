...
VaxPatient _$VaxPatientFromR4({
  ...
  Tuple2 pastDoses = getPastR4Doses(immunizations);
  var assessDate = VaxDate.fromString(assessmentDate);
...
Tuple2<List<Dose>, List<Dose>> getPastR4Doses(
    List<r4.Immunization> immunizations) {
  List pastImmunizations = <Dose>[];
  List liveVirusList = <Dose>[];
