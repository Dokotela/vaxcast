...
### (This is chapter 3 in the [CDC pdf](documentation/cdc/logic-spec-acip-rec-4.0.pdf))
## 1.1 Target Dose
...
![Figure 3-1](documentation/images/3-1%20How%20a%20Vaccine%20Dose%20Administered%20Satisfies%20a%20Target%20Dose)
...
I've defined and coded most of the date rules, uses and requirements into a class called [VaxDate](lib/features/immunizationForecast/domain/entities/vaxDate.dart).
