...
final rubella = AntigenSupportingData.fromJson({
  "targetDisease": "Rubella",
  "vaccineGroup": "MMR",
  "immunity": {
    "clinicalHistory": [
      {"guidelineTitle": "Laboratory Evidence of Immunity for Rubella"}
    ],
    "dateOfBirth": {
  ...
  "series": [
              ...
              "set": [
                {
                  "setID": "1",
                  "setDescription":
                      "Dose is not required for those 19 year or older",
                  "condition": [
                    {
                      "conditionID": "1",
                      "conditionType": "Age",
    ...
    {
      "seriesName": "Rubella risk 1-dose series",
      "targetDisease": "Rubella",
      "vaccineGroup": "MMR",
      "seriesAdminGuidance": [
    ...
    },
    {
      ...
      "indication": [
        ...
        {
          "observationCode": {"text": "Health care personnel"},
          "description":
              "Administer to healthcare personnel without evidence of immunity.",
          "beginAge": "18 years",
          "guidance":
              "Includes those born before 1957 who would normally be considered immunity."
        },
        {
          "observationCode": {"text": "Post secondary student"},
          "description":
        ...
        },
        {
          ...
          "description":
              "Administer to persons who have HIV/AIDS but are not severely immunocompromised (See the CDC general recommendations for a definition of severely immunocompromised).",
          "beginAge": "18 years"
        }
      ],
      "seriesDose": [
    ...
    {
      "seriesName": "Rubella risk 2-dose ART series",
      "targetDisease": "Rubella",
      "vaccineGroup": "MMR",
      "seriesType": "Risk",
      "selectSeries": {
