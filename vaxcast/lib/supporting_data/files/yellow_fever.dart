...
final yellow_fever = AntigenSupportingData.fromJson({
    ...
    "vaccineGroup": {
      "contraindication": [
        ...
        },
        {
          ...
          "contraindicationText":
              "Do not vaccinate if the patient has had a severe allergic reaction to egg protein."
        },
        {
  ...
  "series": [
    {
      ...
      "vaccineGroup": "Yellow Fever",
      "seriesAdminGuidance": [
        "A single primary dose of yellow fever vaccine provides long-lasting protection and is adequate for most travelers but additional doses of yellow fever vaccine are recommended for certain travelers with ongoing risk.",
        "Women who were pregnant (regardless of trimester) when they received their initial dose of yellow fever vaccine should receive 1 additional dose of yellow fever vaccine",
        "Persons who received a hematopoietic stem cell transplant after receiving a dose of yellow fever vaccine and who are sufficiently immunocompetent to be safely vaccinated should be revaccinated",
        ...
        "Persons who were infected with HIV when they received their last dose of yellow fever vaccine should receive a dose every 10 years if they continue to be at risk for yellow fever virus infection."
      ],
      "seriesType": "Risk",
      "selectSeries": {
        "defaultSeries": "No",
      ...
      "indication": [
        ...
        },
        {
          ...
          "beginAge": "9 months",
          "guidance":
              "If travel is unavoidable, the decision to vaccinate travelers aged ≥60 years needs to weigh the risks and benefits of the vaccination in the context of their destination-specific risk for exposure to YFV."
        }
      ],
      "seriesDose": [
        {
          ...
          "allowableVaccine": [
            ...
            {
              "vaccineType": "Yellow fever, unspecified formulation",
              "cvx": "184",
              "beginAge": "6 months"
            }
          ],
