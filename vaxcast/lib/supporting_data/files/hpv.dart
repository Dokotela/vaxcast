...
final hpv = AntigenSupportingData.fromJson({
    ...
    "vaccineGroup": {
      "contraindication": [
        ...
        },
        {
          ...
          "contraindicationText":
              "Do not vaccinate with 9vHPV if the patient has a hypersensitivity to yeast."
        }
      ]
    }
  },
  "series": [
    ...
    },
    {
      ...
      "indication": [
        {
          "observationCode": {"text": "History of sexual abuse or assault"},
          "description":
    ...
    },
    {
      ...
      "indication": [
        ...
        },
        {
          ...
          "description":
              "Administer to persons who have T-lymphocyte [cell-mediated and humoral] - interferon-gamma/Interleukin 12 axis deficiencies.",
          "beginAge": "9 years"
        },
        {
          "observationCode": {
